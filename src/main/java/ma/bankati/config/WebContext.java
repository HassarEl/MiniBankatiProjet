    ...
    static void loadApplicationContext(ServletContext application){
        ...
        if (configFile != null) {
            ...
            try {
                ...
                String pondServClassName = properties.getProperty("pondDao");
                String dhServClassName = properties.getProperty("dhService");
                String usdServClassName = properties.getProperty("usdService");
                ...
                Class<?> cMoneyService = Class.forName(dhServClassName);
