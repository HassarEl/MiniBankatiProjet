...
<div class="container w-75 mt-5 mb-5 bg-white p-4 rounded-3 shadow-sm border border-light">
	<div class="d-flex flex-column align-items-center">
		<img src="${pageContext.request.contextPath}/assets/img/profile.png" alt="profile" class="img-fluid">
		<h4 class="text-center text-primary mb-4">Mr . ${connectedUser.firstName} ${connectedUser.lastName}</h4>
	</div>
	...
	<div class="border border-primary rounded-4 p-4 mt-5 mb-5 shadow-sm bg-white w-75 mx-auto">
		...
		<h5 class="text-center bold blue">
			<c:choose>
				<c:when test="${not empty connectedUser}">Modifier le Profile</c:when>
				<c:otherwise>Ajouter un nouveau utilisateur</c:otherwise>
			</c:choose>
		</h5>
		
		<form action="${pageContext.request.contextPath}/profile/save" method="post" class="mt-3">
			...
			<div class="mb-3">
				...
				<span class="input-group-text bg-white">
					...
					<input type="text" class="form-control text-dark bold" name="firstName" placeholder="Prénom" value="${connectedUser.firstName}"/>
				</div>
			</div>
			...
			<div class="mb-3">
				...
				<span class="input-group-text bg-white">
					...
					<input type="text" class="form-control text-dark bold" name="lastName" placeholder="Nom" value="${connectedUser.lastName}"/>
				</div>
			</div>
			...
			<div class="mb-3">
				...
				<span class="input-group-text bg-white">
					...
					<input type="text" class="form-control text-dark bold" name="username" placeholder="Nom d'utilisateur" value="${connectedUser.username}"/>
				</div>
			</div>

			<input type="hidden" name="role" value="${connectedUser.role}">
			...
			<div class="mb-3">
				...
				<span class="input-group-text bg-white">
					...
					<input type="password" class="form-control text-dark bold" name="password" placeholder="Mot de passe" value="${connectedUser.password}"/>
				</div>
			</div>
